             ...
             //       Singdata = memory.ToArray();
              //  }
                ...
                if (await Application.Current.MainPage.DisplayAlert("Message", "Are you sure you want to submit?", "Yes", "No"))
                {
                    ...
                    var client = new RestClient("https://18.139.49.140:8090/api/booking?$filter=bookingId eq " + "" + HWBNo + "");
                    client.Timeout = -1;
                    ...
                    if (response.IsSuccessful == true)
                    {
                        ...
                        if (responsex.IsSuccessful == true)
                        {
                            ...
                            var clientV = new RestClient("https://18.139.49.140:8090/api/bookingimg");
                            clientV.Timeout = -1;
